...
namespace CreateRealTimeTrendData
{
    public partial class Form1 : Form, iATester.iCom
    {
        ...
        string baseUrl;
        string sTestItemName = "CreateRealTimeTrendData";
        ...
        private void CreateRealTimeTrend()
        {
            //driver.SwitchTo().Frame("rightFrame");
            //driver.FindElement(By.XPath("//a[contains(@href, '/broadWeb/bwMainRight.asp') and contains(@href, 'pos=RTrendList')]")).Click();
            driver.FindElement(By.XPath("//a[contains(@href, '/broadWeb/rtrend/RTrendPg.asp') and contains(@href, 'action=add_rtrend')]")).Click();

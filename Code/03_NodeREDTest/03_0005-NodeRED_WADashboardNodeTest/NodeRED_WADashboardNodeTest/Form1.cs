...
namespace NodeRED_WADashboardNodeTest
{
    public partial class Form1 : Form, iATester.iCom
    {
        ...
        public void StartTest()
        {
            //Add test code
            long lErrorCode = 0;
            EventLog.AddLog("===NodeRED_WADashboardNode test start (by iATester)===");
            ...
            EventLog.AddLog("===NodeRED_WADashboardNode test end (by iATester)===");
        ...
        long Form1_Load(string sProjectName, string sWebAccessIP, string sTestLogFolder, string sBrowser)
        {
             ...
             * 6 刪除第2個分頁
             */
            bool bNodeREDResult = bNodeREDDashboardNodeTest(sProjectName, sTestLogFolder);
        ...
        {
            long lErrorCode = 0;
            EventLog.AddLog("===NodeRED_WADashboardNode test start===");
            CheckifIniFileChange();
            EventLog.AddLog("Project= " + ProjectName.Text);
            EventLog.AddLog("WebAccess IP address= " + WebAccessIP.Text);
            lErrorCode = Form1_Load(ProjectName.Text, WebAccessIP.Text, TestLogFolder.Text, Browser.Text);
            EventLog.AddLog("===NodeRED_WADashboardNode test end===");
        }
